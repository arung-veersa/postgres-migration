-- PART 1: Update conflicts where ConVisit HAS InService but Visit has NO InService
...
WITH source_data AS (
    SELECT 
        ...
        END AS "ContractType",
        -- Visit side InService (should be NULL for Part 1)
        ...
        -- ConVisit side InService (should be populated for Part 1)
