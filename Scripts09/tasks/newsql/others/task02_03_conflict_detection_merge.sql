-- ============================================================================
-- TASK_02+03: Conflict Detection & Sync (CONSOLIDATED MERGE)
-- ============================================================================
-- Purpose:
...
USING (
    ...
    FROM (
        -- ====================================================================
        -- V1: Primary visit source (from conflictvisitmaps with CONFLICTID)
        -- ====================================================================
        SELECT DISTINCT 
            CVM1."CONFLICTID",
    ...
    LEFT JOIN (
        -- ====================================================================
        -- V2: Conflicting visit source (all visits, no CONFLICTID filter)
        -- ====================================================================
        SELECT DISTINCT 
