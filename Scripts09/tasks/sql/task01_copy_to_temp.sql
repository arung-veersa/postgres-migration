-- ============================================================================
-- TASK_01 - Step 4: Copy data from CONFLICTVISITMAPS to CONFLICTVISITMAPS_TEMP
-- ============================================================================
-- Purpose: Copy conflict visit maps data for the last 2 years + 45 days forward
-- 
-- Note: Only columns that exist in conflictvisitmaps_temp are selected.
-- The Snowflake original had more columns, but we match only what exists in temp table.
-- 
-- Schema Placeholders:
