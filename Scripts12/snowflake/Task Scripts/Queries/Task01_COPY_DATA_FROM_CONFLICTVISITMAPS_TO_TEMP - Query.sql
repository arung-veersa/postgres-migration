INSERT
	INTO
	CONFLICTREPORT."PUBLIC".PAYER_PROVIDER_REMINDERS
	("PayerID",
	"AppPayerID",
	"Contract",
	"ProviderID",
...
INNER JOIN ANALYTICS.BI.DIMPAYERPROVIDER AS DPP ON
	DPP."Provider Id" = DP."Provider Id"
INNER JOIN ANALYTICS.BI.DIMPAYER AS DPA ON
	DPA."Payer Id" = DPP."Payer Id"
WHERE
	NOT EXISTS (
	SELECT
		1
...
INSERT
	INTO
	CONFLICTREPORT."PUBLIC".CONFLICTVISITMAPS_TEMP (ID,
	CONFLICTID,
	SSN,
	"ProviderID",
	"AppProviderID",
	...
	CVM."ConPName",
	CVM."ConPAddressID",
	CVM."ConPAppAddressID",
	CVM."ConPAddressL1",
	CVM."ConPAddressL2",
	CVM."ConPCity",
	CVM."ConPAddressState",
	CVM."ConPZipCode",
	CVM."ConPCounty",
	CVM."ConPLongitude",
	CVM."ConPLatitude",
	...
	CVM."InserviceStartDate",
	CVM."InserviceEndDate",
	CVM."PTOStartDate",
	CVM."PTOEndDate",
	CVM."ConInserviceStartDate",
	CVM."ConInserviceEndDate",
	CVM."ConPTOStartDate",
	CVM."ConPTOEndDate",
	CVM."ServiceCodeID",
	CVM."AppServiceCodeID",
	CVM."RateType",
	CVM."ServiceCode",
	CVM."ConServiceCodeID",
	CVM."ConAppServiceCodeID",
	CVM."ConRateType",
	CVM."ConServiceCode",
	CVM."SameSchTimeFlag",
	CVM."SameVisitTimeFlag",
	...
	CVM."ConPLName",
	CVM."PMedicaidNumber",
	CVM."ConPMedicaidNumber",
	CVM."PayerState",
	CVM."ConPayerState",
	CVM."AgencyContact",
	CVM."ConAgencyContact",
	CVM."AgencyPhone",
	CVM."ConAgencyPhone",
	CVM."LastUpdatedBy",
	CVM."ConLastUpdatedBy",
	CVM."LastUpdatedDate",
	CVM."ConLastUpdatedDate",
	CVM."BilledRate",
	CVM."TotalBilledAmount",
	CVM."ConBilledRate",
	CVM."ConTotalBilledAmount",
	CVM."IsMissed",
	CVM."MissedVisitReason",
	CVM."EVVType",
	CVM."ConIsMissed",
	CVM."ConMissedVisitReason",
	CVM."ConEVVType",
	CVM."PStatus",
	CVM."ConPStatus",
	CVM."AideStatus",
	...
	CVM."P_AppPatientID",
	CVM."ConP_PatientID",
	CVM."ConP_AppPatientID",
	CVM."PA_PatientID",
	CVM."PA_AppPatientID",
	CVM."ConPA_PatientID",
	CVM."ConPA_AppPatientID",
	CVM."P_PAdmissionID",
	CVM."P_PName",
	CVM."P_PAddressID",
	CVM."P_PAppAddressID",
	...
	CVM."P_PFName",
	CVM."P_PLName",
	CVM."P_PMedicaidNumber",
	CVM."ConP_PAdmissionID",
	CVM."ConP_PName",
	CVM."ConP_PAddressID",
	CVM."ConP_PAppAddressID",
	CVM."ConP_PAddressL1",
	CVM."ConP_PAddressL2",
	CVM."ConP_PCity",
	...
	CVM."ConP_PFName",
	CVM."ConP_PLName",
	CVM."ConP_PMedicaidNumber",
	CVM."PA_PAdmissionID",
	CVM."PA_PName",
	CVM."PA_PAddressID",
	CVM."PA_PAppAddressID",
	CVM."PA_PAddressL1",
	CVM."PA_PAddressL2",
	CVM."PA_PCity",
	...
	CVM."PA_PFName",
	CVM."PA_PLName",
	CVM."PA_PMedicaidNumber",
	CVM."ConPA_PAdmissionID",
	CVM."ConPA_PName",
	CVM."ConPA_PAddressID",
	CVM."ConPA_PAppAddressID",
	CVM."ConPA_PAddressL1",
	CVM."ConPA_PAddressL2",
	CVM."ConPA_PCity",
	...
	CVM."ConPA_PFName",
	CVM."ConPA_PLName",
	CVM."ConPA_PMedicaidNumber",
	CVM."ContractType",
	CVM."ConContractType",
	CURRENT_TIMESTAMP(),
	CVM."ConNoResponseFlag",
	CVM."ConNoResponseReasonID",
	CVM."ConNoResponseTitle",
	CVM."ConNoResponseNotes",
	CVM."P_PStatus",
	CVM."ConP_PStatus",
	CVM."PA_PStatus",
	CVM."ConPA_PStatus",
	CVM."BillRateNonBilled",
	CVM."ConBillRateNonBilled",
	CVM."BillRateBoth",
	CVM."ConBillRateBoth",
	...
	C."FlagForReview",
	C."FlagForReviewDate",
	CVM."FlagForReview" AS "ConFlagForReview",
	CVM."FlagForReviewDate" AS "ConFlagForReviewDate"
FROM
	CONFLICTREPORT."PUBLIC".CONFLICTVISITMAPS AS CVM
INNER JOIN CONFLICTREPORT."PUBLIC".CONFLICTS AS C ON
	C.CONFLICTID = CVM.CONFLICTID
WHERE
