...
AS '
	try {
	    ...
	    var truncateStmt = snowflake.createStatement({
	        sqlText: `TRUNCATE TABLE CONFLICTREPORT.PUBLIC.PAYER_DASHBOARD_TOP`
	    });
	    truncateStmt.execute();
	    var truncate1Stmt = snowflake.createStatement({
	        sqlText: `TRUNCATE TABLE CONFLICTREPORT.PUBLIC.PAYER_DASHBOARD_CON_TYP`
	    });
	    truncate1Stmt.execute();
		var truncate2Stmt = snowflake.createStatement({
	        sqlText: `TRUNCATE TABLE CONFLICTREPORT.PUBLIC.PAYER_DASHBOARD_AGENCY`
	    });
	    truncate2Stmt.execute();
		var truncate3Stmt = snowflake.createStatement({
	        sqlText: `TRUNCATE TABLE CONFLICTREPORT.PUBLIC.PAYER_DASHBOARD_CAREGIVER`
	    });
	    truncate3Stmt.execute();
		var truncate4Stmt = snowflake.createStatement({
	        sqlText: `TRUNCATE TABLE CONFLICTREPORT.PUBLIC.PAYER_DASHBOARD_PATIENT`
	    });
	    truncate4Stmt.execute();
		var truncate5Stmt = snowflake.createStatement({
	        sqlText: `TRUNCATE TABLE CONFLICTREPORT.PUBLIC.PAYER_DASHBOARD_PAYER`
	    });
	    ...
	    while (payerResult.next()) {
			...
			//-------------------------PAYER TOP---------------------
			var dashboard_top = `
			INSERT INTO CONFLICTREPORT.PUBLIC.PAYER_DASHBOARD_TOP (PAYERID, STATUS, STATUS_VALUE, SEVEN_TO, SEVEN_SP, SEVEN_OP, SEVEN_FP, THIRTY_TO, THIRTY_SP, THIRTY_OP, THIRTY_FP, SIXTY_TO, SIXTY_SP, SIXTY_OP, SIXTY_FP, NINETY_TO, NINETY_SP, NINETY_OP, NINETY_FP)
			SELECT
				''${payerId}'' AS PAYERID,
				...
				SUM(CASE WHEN TO_CHAR(a."G_CRDATEUNIQUE", ''YYYY-MM-DD'') BETWEEN TO_CHAR(CURRENT_DATE - 7, ''YYYY-MM-DD'') AND TO_CHAR(CURRENT_DATE, ''YYYY-MM-DD'') AND a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 THEN TIMESTAMPDIFF(MINUTE, a."ShVTSTTime", a."ShVTENTime") * a."BilledRateMinute" ELSE 0 END) AS "ShiftPrice7",
				SUM( CASE WHEN TO_CHAR(a."G_CRDATEUNIQUE", ''YYYY-MM-DD'') BETWEEN TO_CHAR(CURRENT_DATE - 7, ''YYYY-MM-DD'') AND TO_CHAR(CURRENT_DATE, ''YYYY-MM-DD'') AND a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND b."ShVTSTTime" >= a."ShVTSTTime" AND b."ShVTSTTime" <= a."ShVTENTime" AND b."ShVTENTime" > a."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, b."ShVTSTTime", a."ShVTENTime") * a."BilledRateMinute" WHEN TO_CHAR(a."G_CRDATEUNIQUE", ''YYYY-MM-DD'') BETWEEN TO_CHAR(CURRENT_DATE - 7, ''YYYY-MM-DD'') AND TO_CHAR(CURRENT_DATE, ''YYYY-MM-DD'') AND a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND a."ShVTSTTime" >= b."ShVTSTTime" AND a."ShVTSTTime" <= b."ShVTENTime" AND a."ShVTENTime" > b."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, a."ShVTSTTime", b."ShVTENTime") * a."BilledRateMinute" WHEN TO_CHAR(a."G_CRDATEUNIQUE", ''YYYY-MM-DD'') BETWEEN TO_CHAR(CURRENT_DATE - 7, ''YYYY-MM-DD'') AND TO_CHAR(CURRENT_DATE, ''YYYY-MM-DD'') AND a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND b."ShVTSTTime" >= a."ShVTSTTime" AND b."ShVTENTime" <= a."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, b."ShVTSTTime", b."ShVTENTime") * a."BilledRateMinute" WHEN TO_CHAR(a."G_CRDATEUNIQUE", ''YYYY-MM-DD'') BETWEEN TO_CHAR(CURRENT_DATE - 7, ''YYYY-MM-DD'') AND TO_CHAR(CURRENT_DATE, ''YYYY-MM-DD'') AND a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND a."ShVTSTTime" >= b."ShVTSTTime" AND a."ShVTENTime" <= b."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, a."ShVTSTTime", a."ShVTENTime") * a."BilledRateMinute" WHEN TO_CHAR(a."G_CRDATEUNIQUE", ''YYYY-MM-DD'') BETWEEN TO_CHAR(CURRENT_DATE - 7, ''YYYY-MM-DD'') AND TO_CHAR(CURRENT_DATE, ''YYYY-MM-DD'') AND a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND b."ShVTSTTime" < a."ShVTSTTime" AND b."ShVTENTime" > a."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, a."ShVTSTTime", a."ShVTENTime") * a."BilledRateMinute" WHEN TO_CHAR(a."G_CRDATEUNIQUE", ''YYYY-MM-DD'') BETWEEN TO_CHAR(CURRENT_DATE - 7, ''YYYY-MM-DD'') AND TO_CHAR(CURRENT_DATE, ''YYYY-MM-DD'') AND a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND a."ShVTSTTime" < b."ShVTSTTime" AND a."ShVTENTime" > b."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, b."ShVTSTTime", b."ShVTENTime") * a."BilledRateMinute" ELSE 0 END ) AS "OverlapPrice7",
				...
				SUM(CASE WHEN TO_CHAR(a."G_CRDATEUNIQUE", ''YYYY-MM-DD'') BETWEEN TO_CHAR(CURRENT_DATE - 30, ''YYYY-MM-DD'') AND TO_CHAR(CURRENT_DATE, ''YYYY-MM-DD'') AND a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 THEN TIMESTAMPDIFF(MINUTE, a."ShVTSTTime", a."ShVTENTime") * a."BilledRateMinute" ELSE 0 END) AS "ShiftPrice30",
				SUM( CASE WHEN TO_CHAR(a."G_CRDATEUNIQUE", ''YYYY-MM-DD'') BETWEEN TO_CHAR(CURRENT_DATE - 30, ''YYYY-MM-DD'') AND TO_CHAR(CURRENT_DATE, ''YYYY-MM-DD'') AND a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND b."ShVTSTTime" >= a."ShVTSTTime" AND b."ShVTSTTime" <= a."ShVTENTime" AND b."ShVTENTime" > a."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, b."ShVTSTTime", a."ShVTENTime") * a."BilledRateMinute" WHEN TO_CHAR(a."G_CRDATEUNIQUE", ''YYYY-MM-DD'') BETWEEN TO_CHAR(CURRENT_DATE - 30, ''YYYY-MM-DD'') AND TO_CHAR(CURRENT_DATE, ''YYYY-MM-DD'') AND a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND a."ShVTSTTime" >= b."ShVTSTTime" AND a."ShVTSTTime" <= b."ShVTENTime" AND a."ShVTENTime" > b."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, a."ShVTSTTime", b."ShVTENTime") * a."BilledRateMinute" WHEN TO_CHAR(a."G_CRDATEUNIQUE", ''YYYY-MM-DD'') BETWEEN TO_CHAR(CURRENT_DATE - 30, ''YYYY-MM-DD'') AND TO_CHAR(CURRENT_DATE, ''YYYY-MM-DD'') AND a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND b."ShVTSTTime" >= a."ShVTSTTime" AND b."ShVTENTime" <= a."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, b."ShVTSTTime", b."ShVTENTime") * a."BilledRateMinute" WHEN TO_CHAR(a."G_CRDATEUNIQUE", ''YYYY-MM-DD'') BETWEEN TO_CHAR(CURRENT_DATE - 30, ''YYYY-MM-DD'') AND TO_CHAR(CURRENT_DATE, ''YYYY-MM-DD'') AND a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND a."ShVTSTTime" >= b."ShVTSTTime" AND a."ShVTENTime" <= b."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, a."ShVTSTTime", a."ShVTENTime") * a."BilledRateMinute" WHEN TO_CHAR(a."G_CRDATEUNIQUE", ''YYYY-MM-DD'') BETWEEN TO_CHAR(CURRENT_DATE - 30, ''YYYY-MM-DD'') AND TO_CHAR(CURRENT_DATE, ''YYYY-MM-DD'') AND a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND b."ShVTSTTime" < a."ShVTSTTime" AND b."ShVTENTime" > a."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, a."ShVTSTTime", a."ShVTENTime") * a."BilledRateMinute" WHEN TO_CHAR(a."G_CRDATEUNIQUE", ''YYYY-MM-DD'') BETWEEN TO_CHAR(CURRENT_DATE - 30, ''YYYY-MM-DD'') AND TO_CHAR(CURRENT_DATE, ''YYYY-MM-DD'') AND a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND a."ShVTSTTime" < b."ShVTSTTime" AND a."ShVTENTime" > b."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, b."ShVTSTTime", b."ShVTENTime") * a."BilledRateMinute" ELSE 0 END ) AS "OverlapPrice30",
				...
				SUM(CASE WHEN TO_CHAR(a."G_CRDATEUNIQUE", ''YYYY-MM-DD'') BETWEEN TO_CHAR(CURRENT_DATE - 60, ''YYYY-MM-DD'') AND TO_CHAR(CURRENT_DATE, ''YYYY-MM-DD'') AND a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 THEN TIMESTAMPDIFF(MINUTE, a."ShVTSTTime", a."ShVTENTime") * a."BilledRateMinute" ELSE 0 END) AS "ShiftPrice60",
				SUM( CASE WHEN TO_CHAR(a."G_CRDATEUNIQUE", ''YYYY-MM-DD'') BETWEEN TO_CHAR(CURRENT_DATE - 60, ''YYYY-MM-DD'') AND TO_CHAR(CURRENT_DATE, ''YYYY-MM-DD'') AND a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND b."ShVTSTTime" >= a."ShVTSTTime" AND b."ShVTSTTime" <= a."ShVTENTime" AND b."ShVTENTime" > a."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, b."ShVTSTTime", a."ShVTENTime") * a."BilledRateMinute" WHEN TO_CHAR(a."G_CRDATEUNIQUE", ''YYYY-MM-DD'') BETWEEN TO_CHAR(CURRENT_DATE - 60, ''YYYY-MM-DD'') AND TO_CHAR(CURRENT_DATE, ''YYYY-MM-DD'') AND a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND a."ShVTSTTime" >= b."ShVTSTTime" AND a."ShVTSTTime" <= b."ShVTENTime" AND a."ShVTENTime" > b."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, a."ShVTSTTime", b."ShVTENTime") * a."BilledRateMinute" WHEN TO_CHAR(a."G_CRDATEUNIQUE", ''YYYY-MM-DD'') BETWEEN TO_CHAR(CURRENT_DATE - 60, ''YYYY-MM-DD'') AND TO_CHAR(CURRENT_DATE, ''YYYY-MM-DD'') AND a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND b."ShVTSTTime" >= a."ShVTSTTime" AND b."ShVTENTime" <= a."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, b."ShVTSTTime", b."ShVTENTime") * a."BilledRateMinute" WHEN TO_CHAR(a."G_CRDATEUNIQUE", ''YYYY-MM-DD'') BETWEEN TO_CHAR(CURRENT_DATE - 60, ''YYYY-MM-DD'') AND TO_CHAR(CURRENT_DATE, ''YYYY-MM-DD'') AND a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND a."ShVTSTTime" >= b."ShVTSTTime" AND a."ShVTENTime" <= b."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, a."ShVTSTTime", a."ShVTENTime") * a."BilledRateMinute" WHEN TO_CHAR(a."G_CRDATEUNIQUE", ''YYYY-MM-DD'') BETWEEN TO_CHAR(CURRENT_DATE - 60, ''YYYY-MM-DD'') AND TO_CHAR(CURRENT_DATE, ''YYYY-MM-DD'') AND a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND b."ShVTSTTime" < a."ShVTSTTime" AND b."ShVTENTime" > a."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, a."ShVTSTTime", a."ShVTENTime") * a."BilledRateMinute" WHEN TO_CHAR(a."G_CRDATEUNIQUE", ''YYYY-MM-DD'') BETWEEN TO_CHAR(CURRENT_DATE - 60, ''YYYY-MM-DD'') AND TO_CHAR(CURRENT_DATE, ''YYYY-MM-DD'') AND a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND a."ShVTSTTime" < b."ShVTSTTime" AND a."ShVTENTime" > b."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, b."ShVTSTTime", b."ShVTENTime") * a."BilledRateMinute" ELSE 0 END ) AS "OverlapPrice60",
				...
				SUM(CASE WHEN a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 THEN TIMESTAMPDIFF(MINUTE, a."ShVTSTTime", a."ShVTENTime") * a."BilledRateMinute" ELSE 0 END) AS "ShiftPriceAll",
				SUM( CASE WHEN a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND b."ShVTSTTime" >= a."ShVTSTTime" AND b."ShVTSTTime" <= a."ShVTENTime" AND b."ShVTENTime" > a."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, b."ShVTSTTime", a."ShVTENTime") * a."BilledRateMinute" WHEN a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND a."ShVTSTTime" >= b."ShVTSTTime" AND a."ShVTSTTime" <= b."ShVTENTime" AND a."ShVTENTime" > b."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, a."ShVTSTTime", b."ShVTENTime") * a."BilledRateMinute" WHEN a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND b."ShVTSTTime" >= a."ShVTSTTime" AND b."ShVTENTime" <= a."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, b."ShVTSTTime", b."ShVTENTime") * a."BilledRateMinute" WHEN a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND a."ShVTSTTime" >= b."ShVTSTTime" AND a."ShVTENTime" <= b."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, a."ShVTSTTime", a."ShVTENTime") * a."BilledRateMinute" WHEN a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND b."ShVTSTTime" < a."ShVTSTTime" AND b."ShVTENTime" > a."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, a."ShVTSTTime", a."ShVTENTime") * a."BilledRateMinute" WHEN a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND a."ShVTSTTime" < b."ShVTSTTime" AND a."ShVTENTime" > b."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, b."ShVTSTTime", b."ShVTENTime") * a."BilledRateMinute" ELSE 0 END ) AS "OverlapPriceAll",
			...
			var insercontypes = `
				INSERT INTO CONFLICTREPORT.PUBLIC.PAYER_DASHBOARD_CON_TYP (PAYERID, CRDATEUNIQUE, CONTYPE, CONTYPES, CO_TO, CO_SP, CO_OP, CO_FP)
				SELECT
				*
				FROM
					(
			...
			//-------------------------PAYER AGENCY---------------------
			var inseragency = `
			INSERT INTO CONFLICTREPORT.PUBLIC.PAYER_DASHBOARD_AGENCY (PAYERID, CRDATEUNIQUE, PROVIDERID, P_NAME, TIN, CON_TO, CON_SP, CON_OP, CON_FP)
			SELECT
				''${payerId}'' AS PAYERID,
				a.CRDATEUNIQUE,
				...
				SUM(CASE WHEN a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 THEN TIMESTAMPDIFF(MINUTE, a."ShVTSTTime", a."ShVTENTime") * a."BilledRateMinute" ELSE 0 END) AS CON_SP,
				SUM( CASE WHEN a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND b."ShVTSTTime" >= a."ShVTSTTime" AND b."ShVTSTTime" <= a."ShVTENTime" AND b."ShVTENTime" > a."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, b."ShVTSTTime", a."ShVTENTime") * a."BilledRateMinute" WHEN a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND a."ShVTSTTime" >= b."ShVTSTTime" AND a."ShVTSTTime" <= b."ShVTENTime" AND a."ShVTENTime" > b."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, a."ShVTSTTime", b."ShVTENTime") * a."BilledRateMinute" WHEN a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND b."ShVTSTTime" >= a."ShVTSTTime" AND b."ShVTENTime" <= a."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, b."ShVTSTTime", b."ShVTENTime") * a."BilledRateMinute" WHEN a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND a."ShVTSTTime" >= b."ShVTSTTime" AND a."ShVTENTime" <= b."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, a."ShVTSTTime", a."ShVTENTime") * a."BilledRateMinute" WHEN a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND b."ShVTSTTime" < a."ShVTSTTime" AND b."ShVTENTime" > a."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, a."ShVTSTTime", a."ShVTENTime") * a."BilledRateMinute" WHEN a.APID = ''${payerId}'' AND a."BilledRateMinute" > 0 AND a."ShVTSTTime" < b."ShVTSTTime" AND a."ShVTENTime" > b."ShVTENTime" THEN TIMESTAMPDIFF(MINUTE, b."ShVTSTTime", b."ShVTENTime") * a."BilledRateMinute" ELSE 0 END ) AS CON_OP,
			...
			//-------------------------PAYER CAREGIVER---------------------
			var insercareg = `
				INSERT INTO CONFLICTREPORT.PUBLIC.PAYER_DASHBOARD_CAREGIVER (PAYERID, CRDATEUNIQUE, CAREGIVERID, C_NAME, C_LNAME, C_FNAME, CON_TO, CON_SP, CON_OP, CON_FP)
				SELECT
				''${payerId}'' AS PAYERID,
				a."CRDATEUNIQUE",
				a."CaregiverID",
			...
			//-------------------------END PAYER CAREGIVER---------------------
			//-------------------------PAYER PATIENT---------------------
			var inserpat = `INSERT INTO CONFLICTREPORT.PUBLIC.PAYER_DASHBOARD_PATIENT(PAYERID, CRDATEUNIQUE, PATIENTID, PFNAME, PLNAME, PNAME, ADMISSIONID, CON_TO, CON_SP, CON_OP, CON_FP)
			SELECT
				''${payerId}'' AS PAYERID,
				a.CRDATEUNIQUE,
				a.APAID,
			...
			//-------------------------END PAYER CAREGIVER---------------------
			//-------------------------PAYER PAYER---------------------
			var inpayer = `INSERT INTO CONFLICTREPORT.PUBLIC.PAYER_DASHBOARD_PAYER(PAYERID, CRDATEUNIQUE, CONPAYERID, PNAME, CON_TO, CON_SP, CON_OP, CON_FP)
			SELECT
				''${payerId}'' AS PAYERID,
				a.CRDATEUNIQUE,
				a.APID,
