...
/* {"app": "dbt", "dbt_version": "2026.1.26+c924ee8", "profile_name": "user", "target_name": "prod", "node_id": "model.hha.DimCaregiver"} */;
...
/* {"app": "dbt", "dbt_version": "2026.1.26+c924ee8", "profile_name": "user", "target_name": "prod", "node_id": "model.hha.DimContract"} */;
...
/* {"app": "dbt", "dbt_version": "2026.1.26+c924ee8", "profile_name": "user", "target_name": "prod", "node_id": "model.hha.DimOffice"} */;
...
select
    *, 'hha' as "Source System",
hash("Patient Id","Payer Id","Application Patient Id","Patient Firstname","Patient Lastname","Patient Name","Admission Id","Medicaid Number","Status","Has Visit","Updated Datatimestamp") as "Conflict Report Hash"
from hha_patient
...
/* {"app": "dbt", "dbt_version": "2026.1.26+c924ee8", "profile_name": "user", "target_name": "prod", "node_id": "model.hha.DimPatient"} */;
...
/* {"app": "dbt", "dbt_version": "2026.1.26+c924ee8", "profile_name": "user", "target_name": "prod", "node_id": "model.hha.DimPatientAddress"} */;
...
/* {"app": "dbt", "dbt_version": "2026.1.26+c924ee8", "profile_name": "user", "target_name": "prod", "node_id": "model.hha.DimPayer"} */;
...
create or replace view ANALYTICS.BI.DIMPAYERPROVIDER(
	"Payer Id" COMMENT 'Payer Primary Key',
	"Application Payer Id" COMMENT 'Tags or system purposes',
	"Contract Id" COMMENT 'Contract Primary Key',
	"Application Contract Id" COMMENT 'Tags or system purposes',
	"Provider Id" COMMENT 'Provider Primary Key',
	"Application Provider Id" COMMENT 'Tags or system purposes',
	"Environment" COMMENT 'Environment',
	"Not Rounding Visit Time" COMMENT 'Not Rounding Visit Time',
	"Chha Vendor Id" COMMENT 'Chha Vendor Id',
	"Bill Unbalanced" COMMENT 'Bill Unbalanced',
	"Bill Missed Visit" COMMENT 'Bill Missed Visit',
	"Bill Temp Aide" COMMENT 'Bill Temp Aide',
	"Bill Non Aide Compliant" COMMENT 'Bill Non Aide Compliant',
	"Bill Non POC Compliant" COMMENT 'Bill Non POC Compliant',
	"Bill Overlapping Patient" COMMENT 'Bill Overlapping Patient',
	"Bill Overlapping Aide" COMMENT 'Bill Overlapping Aide',
	"Bill Restricted Aide" COMMENT 'Bill Restricted Aide',
	"Bill Timesheet Not Approved" COMMENT 'Bill Timesheet Not Approved',
	"Bill Insufficient Duty Minutes" COMMENT 'Bill Insufficient Duty Minutes',
	"Bill Missing Clinical Document" COMMENT 'Bill Missing Clinical Document',
	"Bill Non Custom Validation Compliance" COMMENT 'Bill Non Custom Validation Compliance',
	"Bill Non Mediciand Compliance" COMMENT 'Bill Non Mediciand Compliance',
	"Bill Open Event" COMMENT 'Bill Open Event',
	"Bill Over 24 Hours" COMMENT 'Bill Over 24 Hours',
	"Bill Unauthorized" COMMENT 'Bill Unauthorized',
	"Usage Tags" COMMENT 'Usage Tags',
	"Source System",
	"Conflict Report Hash"
) WITH ROW ACCESS POLICY ANALYTICS.CORE.DATA_RESTRICT_POLICY ON ("Usage Tags")
 COMMENT='Dimension representing Payers, with a row per unique Payer. Primary Key - \"Payer Id\"'
...
(
    ...
    from core.evv_payer_provider
)

select
    *, 'hha' as "Source System",
hash("Payer Id","Application Payer Id","Provider Id","Application Provider Id") as "Conflict Report Hash"
from hha_payer_provider
...
select
    *, 'evv' as "Source System",
hash("Payer Id","Application Payer Id","Provider Id","Application Provider Id") as "Conflict Report Hash"
from evv_payer_provider
  )
/* {"app": "dbt", "dbt_version": "2026.1.26+c924ee8", "profile_name": "user", "target_name": "prod", "node_id": "model.hha.DimPayerProvider"} */;
...
/* {"app": "dbt", "dbt_version": "2026.1.26+c924ee8", "profile_name": "user", "target_name": "prod", "node_id": "model.hha.DimProvider"} */;
...
/* {"app": "dbt", "dbt_version": "2026.1.26+c924ee8", "profile_name": "user", "target_name": "prod", "node_id": "model.hha.DimServiceCode"} */;
...
hash("User Id","Application User Id","User Fullname","User Email Address","Vendor Id","Application Vendor Id","Aggregator Database Name") as "Conflict Report Hash"
from hha_user
...
/* {"app": "dbt", "dbt_version": "2026.1.26+c924ee8", "profile_name": "user", "target_name": "prod", "node_id": "model.hha.DimUser"} */;
...
select *, 'hha' as "Source System",
hash("User Id","Office Id","Vendor Id","Vendor Type") as "Conflict Report Hash"
from hha_user_offices

union all

select *, 'evv' as "Source System",
hash("User Id","Office Id","Vendor Id","Vendor Type") as "Conflict Report Hash"
from evv_user_offices
  )
/* {"app": "dbt", "dbt_version": "2026.1.26+c924ee8", "profile_name": "user", "target_name": "prod", "node_id": "model.hha.DimUserOffices"} */;
...
/* {"app": "dbt", "dbt_version": "2026.1.26+c924ee8", "profile_name": "user", "target_name": "prod", "node_id": "model.hha.FactCaregiverAbsence"} */;
...
/* {"app": "dbt", "dbt_version": "2026.1.26+c924ee8", "profile_name": "user", "target_name": "prod", "node_id": "model.hha.FactCaregiverInService"} */;
...
(
    ...
    and
        "Visit Date" >= cast('2026-01-28 21:05:41.303520-05:00' as date)-interval '18 month' /*and CURRENT_DATE() + 60*/

    
        and
        (
        "Usage Tags":providerState in ('NY', 'PA') and "Usage Tags":payerState    in ('NY', 'PA', '<NULL>', 'UNKNOWN')
        or
        "Usage Tags":payerState    in ('NY', 'PA') and "Usage Tags":providerState in ('NY', 'PA', '<NULL>', 'UNKNOWN')
        )
...
hash("Visit Id",
	...
	"Visit Updated User Id",
    "Application Visit Updated User Id",
    "Bill Rate Non-Billed") as "Conflict Report Hash"
from data
  )
/* {"app": "dbt", "dbt_version": "2026.1.26+c924ee8", "profile_name": "user", "target_name": "prod", "node_id": "model.hha.FactVisitCallPerformance_CR"} */;
...
hash("Visit Id",
    ...
    "Visit Updated User Id",
    "Application Visit Updated User Id",
    "Visit Updated Timestamp") as "Conflict Report Hash"
from data
  )
/* {"app": "dbt", "dbt_version": "2026.1.26+c924ee8", "profile_name": "user", "target_name": "prod", "node_id": "model.hha.FactVisitCallPerformance_Deleted_CR"} */;