...
create or replace TABLE CONFLICTREPORT.PUBLIC.CONFLICTVISITMAPS (
	...
	"AggFlagForReviewDate" TIMESTAMP_NTZ(9),
	primary key (ID)
);
...
create or replace dynamic table CONFLICTREPORT.PUBLIC.DT_PAYER_CONFLICTS_COMMON(
	...
	COSTTYPE,
	VISITTYPE
) target_lag = '5 minutes' refresh_mode = AUTO initialize = ON_CREATE warehouse = CONFLICTREPORT_APP_WH
 as
select *
from CONFLICTREPORT.PUBLIC.V_PAYER_CONFLICTS_COMMON;
